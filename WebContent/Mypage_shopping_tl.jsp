	...
	<div class="mypage_menu_tl">
		<nav class="up MYmenu">
			<ul class="up_menu_inner">
				<li class="nav_button">
					<a class="active upb y_active_on_just_color" href="#">프로필</a>
				</li>
				<li class="nav_button">
					<a class="active upb" href="#">나의 쇼핑</a>
				</li>
				<li class="nav_button">
					<a class="active upb" href="#">나의 리뷰</a>
				</li>
				<li class="nav_button">
					<a class="active upb" href="#">설정</a>
				</li>
			</ul>
		</nav>
		<nav class="down MYmenu">
			<ul class="up_menu_inner">
				<li class="nav_button under">
					<a class="active downb b1 y_active_on" href="#">모두보기</a>
				</li>
				<li class="nav_button under">
					<a class="active downb" href="#">집들이</a>
				</li>
				<li class="nav_button under">
					<a class="active downb b3" href="#">질문과 답변</a>
				</li>
				<li class="nav_button under">
					<a class="active downb" href="#">좋아요</a>
				</li>
			</ul>
		</nav>
	</div><!-- 위에 상단 메뉴바 끝 -->
	<div><!---------------------------- 요기서 부터 범위잡고 작성하면 됩니다.(임시범위 잡아놓은거) -------------------------------------------->
