...
<head>
	<meta charset="UTF-8">
	<title>공지사항 | 라이프스타일 슈퍼앱, 오늘의집</title>
	...
	<header>
		...
		<div id = "header">
			<div id = "header_inner">
				...
				<div class="homemenu">
					<span class="h_menu"><a href="#">커뮤니티</a></span>
					<span class="h_menu"><a href="#">쇼핑</a></span>
					<span class="h_menu"><a href="#">인테리어</a></span>
				...
				<div class="topSelect">
					...
					<div class="top_icon">
						<div class="top_icon1">
							<a href="#" style = "margin-right: 15px;"><span></span></a> <!--좋아요-->
							<a href="#" style = "margin-right: 15px;"><span></span></a> <!--새소식-->
							<a href="#" style = "margin-right: 15px;"><span></span></a> <!--장바구니-->
						</div>
						<div class="top_icon2">
							<a href="#" style="margin-left: -16px;"><span><img src="https://image.ohou.se/i/bucketplace-v2-development/uploads/default_images/avatar.png?w=72&amp;h=72&amp;c=c"></span></a> <!--프로필사진-->
						</div>
						<div class="top_icon3">
		...
		<div class="sticky-container jy_displaynone" style="height: 52px; top:80px; position:sticky;">
			<div class="menuLine">
				<div class="menuInner">
					<nav id="topMenu">
						<ul>
							<li class="m_line"><a href="#">주거공간시공</a></li>
							<li class="m_line"><a href="#">아파트시공사례</a></li>
						</ul>
					</nav>
					<div class="hot">
						<div class="hot_serch_text">상품명</div>
...
<!--		<div class="myhome_menu">
				...
				<nav class="myhome_menu_content">
					<ul class="nav_all2">
						<li class="nav_button">
							<a class="active" href="#">주문배송내역 조회</a>
						</li>
						<li class="nav_button">
							<a class="active" href="#">좋아요한상품</a>
						</li>
						<li class="nav_button">
							<a class="active" href="#">나의문의내역</a>
						</li>
						<li class="nav_button">
							<a class="active" href="#">포인트</a>
						</li>
						<li class="nav_button">
							<a class="active" href="#">포인트</a>
						</li>   
		...
		<div class="notice_list">
			<h1 class="notice_list_top_title">공지사항</h1>
			<%
			for(NoticeVo vo : listNoticeVo) {
			%>
				<!-- 반복 -->
			<div class="notice_list_content_box">
				<a class="notice_list_content_link" href="Controller?command=Notice_detail&notice_idx=<%=vo.getNoticeIdx()%>">
					<h1 class="notice_list_content_title"><%=vo.getTitle() %></h1>
					<time class="notice_writedate" datetime="2023.11.21 00:00:00">2023.11.21보류</time>
				</a>
			</div>
			<!-- 반복 -->
			<%
