...
<body>
	...
	<!-- class="all" 이벤트 및 혜택알림 -->
	<div class="event-benefit_alram">
		<h1 class="eba_title">이벤트 및 혜택 알림</h1>
		<p class="eba_little_title">특가, 혜택 등 다양한 이벤트 정보를 빠르게 알려드릴게요.</p> 
		<ul class="alram_setting_tl">
			<li class="alram_tl "><span>이메일</span><img class="imsi" src="images/toggle-button.PNG"/></li>
			<li class="alram_tl"><span>문자메세지</span><img class="imsi" src="images/toggle-button.PNG"/></li>
		</ul>
		<p class="warning">알림 수신 동의와 함께 <a>개인정보 마케팅 활용</a>에 대해 동의하시게 됩니다.</p>
	</div>
	<!-- 이벤트 및 혜택알림 끝 -->
	<footer id="footer">
