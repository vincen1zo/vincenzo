...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<% 
//	int noticeIdx = (Integer)request.getAttribute("noticeIdx");
//	String noticeTitle = (String)request.getAttribute("noticeTitle");
//	String noticeWriteDate = (String)request.getAttribute("noticeWriteDate");
//	String noticeContent = (String)request.getAttribute("noticeContent");
	NoticeVo vo = (NoticeVo) request.getAttribute("voRet");
%>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
	<title>오늘의집 VIP 등급 운영정책 변경안내 | 라이프스타일 슈퍼앱, 오늘의집</title>
...
<body>
	...
	<div class="page_notice_detail">
		<div class="page_notice_tl">
			<h1><%= vo.getTitle() %></h1>
			<time class="write_time" datetime="2023-11-21T18:30:25.000+09:00">2023.11.21보류</time>
	<!--  --><div class="notice_content_tl">
				<%= vo.getContent() %>
			</div>
				<button class="to_the_list" onclick="location.href='Notice';">목록으로 돌아가기</button>
		</div>
	</div>
	<footer id="footer">
