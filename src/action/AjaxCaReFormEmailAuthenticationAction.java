...
public class AjaxCaReFormEmailAuthenticationAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//int authenticationCode = 0000; //TODO:random number. //request.getParameter("authenticationCode");
		int authenticationCode = (int)(Math.random() * 900000) + 100000;	//인증번호
		System.out.println(memberId + "\\" + email);
		
		MemberDao mDao = new MemberDao();
		String dateExpire = mDao.ajaxReCaMemberIdEmailAuthentication(memberId, email, authenticationCode);
